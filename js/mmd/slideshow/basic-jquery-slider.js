 ...
 */ (function ($) {
    $.fn.bjqs = function (options) {
        ...
        if (settings.showControls && slideCount > 1) {
            ...
            var $controlContainer = $('<ul class="bjqs-controls v-centered"></ul>'),
                $next = $('<li class="bjqs-next"><a href="#"  class="controls">' + settings.nextText + '</a></li>'),
                $previous = $('<li class="bjqs-prev"><a href="#"  class="controls">' + settings.prevText + '</a></li>');
        ...
        if (settings.showMarkers && slideCount > 1) {
            ...
            var $markerContainer = $('<ol class="bjqs-markers h-centered"></ol>'),
