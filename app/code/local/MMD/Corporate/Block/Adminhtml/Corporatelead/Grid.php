...
class MMD_Corporate_Block_Adminhtml_Corporatelead_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('draft_status', array('header'=>$h->__('Reply Draft'),'index'=>'draft_status','width'=>130,'type'=>'options','options'=>array('pending_review'=>'Pending approval','changes_requested'=>'Changes requested','approved_sent'=>'Approved & sent')));
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('mailerlite', array(
            'label' => Mage::helper('mmd_corporate')->__('Send to MailerLite'),
