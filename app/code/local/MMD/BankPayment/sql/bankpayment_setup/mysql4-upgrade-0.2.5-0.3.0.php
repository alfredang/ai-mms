...
$accountData = array(
	...
	'branch_code'            => array('', $installer->getConnection()->fetchOne("select value from ".$installer->getTable('core/config_data')." where scope='default' and path='payment/bankpayment/branchcode'"))
);
...
$installer->deleteConfigData('payment/bankpayment/branchcode');
$installer->endSetup();