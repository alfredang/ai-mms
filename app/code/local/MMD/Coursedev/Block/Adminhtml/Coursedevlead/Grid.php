<?php
class MMD_Coursedev_Block_Adminhtml_Coursedevlead_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('coursedevLeadGrid');
    ...
    {
        $this->setCollection(Mage::getModel('mmd_coursedev/lead')->getCollection());
        return parent::_prepareCollection();
    }

    protected function _prepareColumns()
    {
        $h = Mage::helper('mmd_coursedev');
