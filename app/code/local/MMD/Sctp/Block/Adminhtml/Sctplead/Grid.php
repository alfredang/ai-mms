<?php
class MMD_Sctp_Block_Adminhtml_Sctplead_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();
        $this->setId('sctpLeadGrid');
    ...
    {
        $this->setCollection(Mage::getModel('mmd_sctp/lead')->getCollection());
        return parent::_prepareCollection();
    }

    protected function _prepareColumns()
    {
        $h = Mage::helper('mmd_sctp');
