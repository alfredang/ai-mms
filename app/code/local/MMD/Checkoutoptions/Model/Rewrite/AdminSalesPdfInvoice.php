 ...
 */
class MMD_Checkoutoptions_Model_Rewrite_AdminSalesPdfInvoice extends Mage_Sales_Model_Order_Pdf_Invoice
{
    ...
    {
        $data = Mage::getModel('checkoutoptions/checkoutoptions')->getInvoiceCustomData($obj->getId() , null , true); 
        if(!empty($data))
        {
            $page->setFillColor(new Zend_Pdf_Color_Rgb(0.93, 0.92, 0.92));
            #$page->setLineWidth(0.5);
            ...
            $headTitle = Mage::getStoreConfig('checkoutoptions/common_settings/checkoutoptions_additionalblock_label');
