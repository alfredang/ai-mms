 ...
 */
class MMD_Checkoutoptions_Model_Rewrite_FrontCatalogProductFlatObserver extends Mage_Catalog_Model_Product_Flat_Observer
{
    /**
    ...
    {
        if ($observer->getEvent()->getAttribute()->getData('mmdflag'))
        {
            return $this;
        }
