...
class MMD_Checkoutoptions_Block_Rewrite_FrontCheckoutMultishippingOverview extends Mage_Checkout_Block_Multishipping_Overview
{
    ...
    {
        $iStepId = Mage::helper('checkoutoptions')->getStepId('mult_overview');
