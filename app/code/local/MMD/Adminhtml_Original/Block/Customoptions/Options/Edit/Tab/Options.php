...
class MMD_Adminhtml_Block_Customoptions_Options_Edit_Tab_Options extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Options {
    ...
    protected function _prepareLayout() {
        ...
        $this->setChild('general_box', $this->getLayout()->createBlock('mmd/customoptions_options_edit_tab_general'));
        $this->setChild('options_box', $this->getLayout()->createBlock('mmd/customoptions_options_edit_tab_options_option'));
