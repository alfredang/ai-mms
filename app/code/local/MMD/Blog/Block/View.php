...
class MMD_Blog_Block_View extends Mage_Core_Block_Template
{
    ...
    public function getShareIcons()
    {
        ...
        $title = rawurlencode($this->getPost()->getTitle());
        $svg = array(
            'linkedin' => '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M4.98 3.5a2.5 2.5 0 1 1 0 5 2.5 2.5 0 0 1 0-5zM3 9h4v12H3zM9 9h3.8v1.7h.05c.53-1 1.83-2.05 3.77-2.05C20.3 8.65 21 10.9 21 14v7h-4v-6.2c0-1.48-.03-3.38-2.06-3.38-2.07 0-2.39 1.62-2.39 3.28V21H9z"/></svg>',
            'x'        => '<svg viewBox="0 0 24 24" fill="currentColor"><path d="M18.24 2h3.3l-7.2 8.24L22.9 22h-6.63l-5.2-6.8L5.12 22H1.8l7.7-8.8L1.4 2h6.8l4.7 6.2zm-1.16 18h1.83L7.02 3.9H5.05z"/></svg>',
