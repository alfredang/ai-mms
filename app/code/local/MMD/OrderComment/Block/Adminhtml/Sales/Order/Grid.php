 ...
 */
class MMD_OrderComment_Block_Adminhtml_Sales_Order_Grid extends Mage_Adminhtml_Block_Sales_Order_Grid
{
    /**
     ...
     *
     * @return MMD_OrderComment_Block_Adminhtml_Sales_Order_Grid
     */
