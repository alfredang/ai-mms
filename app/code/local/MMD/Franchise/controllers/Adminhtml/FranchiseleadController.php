...
class MMD_Franchise_Adminhtml_FranchiseleadController extends Mage_Adminhtml_Controller_Action
{
    ...
    {
        return Mage::getSingleton('admin/session')->isAllowed('admin/mmd_marketing/franchise_leads');
    }

    public function indexAction()
    {
        $this->loadLayout()
            ->_setActiveMenu('mmd_marketing/franchise_leads')
            ->_title($this->__('Marketing'))->_title($this->__('Franchisee Leads'));
