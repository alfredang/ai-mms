-- 758: CASL funding badge for TGS-2026064711 (CASL - Business Innovation
-- with Internet-of-Things (IoT)): swap this product's WSQ badge tag for the
...
SET @e := (SELECT entity_id FROM catalog_product_entity WHERE sku = 'TGS-2026064711');
