...
WHERE e.sku IN ('C171', 'C842', 'C873', 'C1228', 'C425', 'C188', 'C1043', 'C173', 'C150', 'C151')
...
SET i.value = 2
WHERE i.attribute_id = @status_attr AND e.sku IN ('C171', 'C842', 'C873', 'C1228', 'C425', 'C188', 'C1043', 'C173', 'C150', 'C151');
