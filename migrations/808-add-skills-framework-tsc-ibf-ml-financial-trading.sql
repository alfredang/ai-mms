-- 808: Add the Skills Framework section (TSC Title + TSC Code) to
-- TGS-2023018794 "IBF - Machine Learning 101 for Financial Trading", whose
...
--
--   TSC Title : Data Analytics and Computational Modelling-3
--   TSC Code  : FSE-DAT-3019-1.1
--
-- Fourth IBF course (after 805-807). Level-3 sibling of migration 805
-- (Data Analytics and Computational Modelling-4 / FSE-DAT-4019-1.1).
...
--
-- Same rendering contract as migrations 789-807: the product-view template
...
SET @e := (SELECT entity_id FROM catalog_product_entity WHERE sku = 'TGS-2023018794');

UPDATE catalog_product_entity_text
SET value = CONCAT(value, '\n', '<h2>Skills Framework</h2>
<p>This course follows the guideline of&nbsp;<strong>Data Analytics and Computational Modelling-3 FSE-DAT-3019-1.1 TSC</strong> under Financial Services Skills Framework</p>')
WHERE entity_id = @e
  AND @e IS NOT NULL
