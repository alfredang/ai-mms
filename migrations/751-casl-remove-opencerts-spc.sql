-- 751: Re-run the CASL OpenCerts rule (see 747/748) for the newly converted
...
-- 'CASL - %', matching BOTH CRLF and LF line endings. Note this course's
-- bullet variant says "Tertiary Infotech"; the storefront template rebuilds
-- the Certification card and already suppresses OpenCerts for CASL names, so
-- this is the belt-and-braces data cleanup. Idempotent; partner-safe.
