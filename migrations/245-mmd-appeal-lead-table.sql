-- 245: Assessment Appeal store for MMD_Appeal.
CREATE TABLE IF NOT EXISTS `mmd_appeal_lead` (
  ...
  `course` VARCHAR(255) NOT NULL DEFAULT '', `assessment_date` VARCHAR(64) NOT NULL DEFAULT '',
  ...
  PRIMARY KEY (`lead_id`), KEY `IDX_APPEAL_CREATED` (`created_at`), KEY `IDX_APPEAL_STATUS` (`status`)
