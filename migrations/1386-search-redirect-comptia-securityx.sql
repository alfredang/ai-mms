-- Search-term redirect: "Comptia SecurityX" -> the matching WSQ course page.
--
-- Keep this exact-match only so longer CompTIA SecurityX searches continue
...
SET @term := 'Comptia SecurityX';
SET @tgt  := 'https://www.tertiarycourses.com.sg/wsq-comptia-certified-securityx-training.html';
