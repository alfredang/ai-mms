-- 791: Add the Skills Framework section (TSC Title + TSC Code) to
-- TGS-2020503207 "WSQ - AI Vibe Coding for Multi Agents System", whose
...
--
-- Same TSC as migration 790 (AI Vibe Coding with Python): the Vibe Coding
-- siblings share this competency. Same shape as migrations 789/790: the
-- product-view template derives the card from this section by regex
...
SET @e := (SELECT entity_id FROM catalog_product_entity WHERE sku = 'TGS-2020503207');
