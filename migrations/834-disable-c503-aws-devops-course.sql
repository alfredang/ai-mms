...
--   C503 - AWS Certified DevOps Engineer Training
--
-- Same pattern as migration 833: default-scope (store_id 0) status set to
...
SET i.value = 2
WHERE i.attribute_id = @status_attr AND e.sku IN ('C503');
