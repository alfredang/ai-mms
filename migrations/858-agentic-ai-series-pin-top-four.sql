-- 858: Extend the pinned order in the Agentic AI Series category
-- (url_key 'agentic-ai-series') to the top four:
...
--
-- Supersedes the top-three block from 857. Negative positions keep these rows
-- ahead of every unpinned course; the daily category-ordering sweep preserves
-- TGS relative order and renumbers them to normal positive positions (the
-- 784/785/786 pattern). Category/products resolved by business key. Idempotent.
