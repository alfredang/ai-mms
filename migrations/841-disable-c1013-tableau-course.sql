...
--   C1013 - Tableau Masterclass
--
-- Same pattern as migrations 833-840: default-scope (store_id 0) status set to
...
SET i.value = 2
WHERE i.attribute_id = @status_attr AND e.sku IN ('C1013');
