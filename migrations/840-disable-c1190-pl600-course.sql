...
--   C1190 - PL-600 Microsoft Power Platform Solution Architect Training
--
-- Same pattern as migrations 833-839: default-scope (store_id 0) status set to
...
SET i.value = 2
WHERE i.attribute_id = @status_attr AND e.sku IN ('C1190');
