-- 321: Custom Course Development enquiry store for MMD_Coursedev.
CREATE TABLE IF NOT EXISTS `mmd_coursedev_lead` (
  ...
  PRIMARY KEY (`lead_id`), KEY `IDX_COURSEDEV_CREATED` (`created_at`), KEY `IDX_COURSEDEV_STATUS` (`status`)
