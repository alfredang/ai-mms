-- 1104: search-term redirect -> the NTUC UTAP funding page (re-fill after 1103; the rows 1103 set were cleared again by the pre-fix controller before the fixed build went live, and an applied migration never re-runs)
--
