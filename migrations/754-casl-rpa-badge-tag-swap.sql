-- 754: CASL funding badge for TGS-2026064721 (CASL - Robotics Process
-- Automation (RPA) for Beginners): swap this product's WSQ badge tag for the
-- canonical CASL tag (seeded by 746; re-seeded here guarded for safety).
-- Storefront chips + cover (set in 753) now both say CASL.
