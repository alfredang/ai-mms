-- 1300: Set the catalog banner image on the "WSQ AI Applications Courses"
-- category (url_key wsq-ai-applications-courses, created by 1296).
--
...
-- (catalog/category/wsq-ai-applications-courses.jpg, uploaded + verified 200),
...
SELECT 3, @cat_image, 0, @cat, 'wsq-ai-applications-courses.jpg'
