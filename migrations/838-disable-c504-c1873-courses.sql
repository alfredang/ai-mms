...
--   C504  - Google Cloud Certified Professional Cloud DevOps Engineer Training
--   C1873 - Manage AI Agents with Paperclip
--
-- Same pattern as migrations 833-837: default-scope (store_id 0) status set to
...
SET i.value = 2
WHERE i.attribute_id = @status_attr AND e.sku IN ('C504', 'C1873');
