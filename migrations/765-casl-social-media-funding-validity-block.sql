-- 765: Funding Validity card for TGS-2026064473 (CASL - Create Social Media
-- Campaigns with Agentic AI). New per-course cms_block
...
SELECT 'Course TGS-2026064473 - Funding Validity', 'course_TGS-2026064473_funding_validity',
       ...
       NOW(), NOW(), 1
FROM DUAL
WHERE EXISTS (SELECT 1 FROM catalog_product_entity WHERE sku = 'TGS-2026064473')
  AND NOT EXISTS (SELECT 1 FROM cms_block WHERE identifier = 'course_TGS-2026064473_funding_validity');

INSERT IGNORE INTO cms_block_store (block_id, store_id)
SELECT b.block_id, 0 FROM cms_block b
WHERE b.identifier = 'course_TGS-2026064473_funding_validity';
