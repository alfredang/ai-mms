-- 1031: CASL funding badge for TGS-2026064178 (CASL - Infographics and Data
-- Visualization with PowerPoint): swap this product's WSQ badge tag for the
-- canonical CASL tag (seeded by 746; re-seeded here guarded for safety).
-- Storefront chips + cover (set in 1030) now both say CASL.
