-- 1071: Autodesk Software Courses category (url_key autodesk-software-courses):
-- move WSQ AutoCAD Civil 3D for Infrastructure Design (TGS-2021005539) to
-- directly after WSQ Architecture Drawing with Revit (TGS-2021004287). Follow-up to 1070: the Application of BIM using Revit course was re-registered as TGS-2026064717 (Aug 2026 CASL batch), so the pin covers BOTH the new and the legacy BIM SKU.
-- Re-pins the full WSQ order from migration 1057 with that one change:
--
--    1. TGS-2021005538 — WSQ Technical Drawing with AutoCAD
--    2. TGS-2023037469 — WSQ Technical Drawing with AutoCAD Mechanical
--    3. TGS-2023037466 — WSQ Technical Drawing with AutoCAD Electrical
--    4. TGS-2023036004 — WSQ Autodesk Certified Professional (ACP) - AutoCAD Design and Drafting
--    5. TGS-2021004287 — WSQ Architecture Drawing with Revit
--    6. TGS-2021005539 — WSQ AutoCAD Civil 3D for Infrastructure Design   << moved
--    7. TGS-2026064717 — Application of BIM using Revit (re-registered; legacy TGS-2022015370 also pinned)
...
SET cp.position = CASE p.sku
  ...
  WHEN 'TGS-2023037469' THEN -14
  WHEN 'TGS-2023037466' THEN -13
  WHEN 'TGS-2023036004' THEN -12
  WHEN 'TGS-2021004287' THEN -11
  WHEN 'TGS-2021005539' THEN -10
  WHEN 'TGS-2026064717' THEN -9
