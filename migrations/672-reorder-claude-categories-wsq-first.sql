-- 672: Re-run the canonical global category reorder (verbatim copy of 545)
-- after TGS-2026061312 was re-homed into Claude AI Series + Claude
-- Certification Exam Prep (671) — the WSQ course must list FIRST there.
-- Paired with 673 which re-applies the curated per-category orders.
