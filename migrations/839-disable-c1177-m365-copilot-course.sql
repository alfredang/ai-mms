...
--   C1177 - Microsoft 365 Copilot Masterclass
--
-- Same pattern as migrations 833-838: default-scope (store_id 0) status set to
...
SET i.value = 2
WHERE i.attribute_id = @status_attr AND e.sku IN ('C1177');
