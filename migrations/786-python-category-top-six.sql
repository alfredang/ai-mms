-- 786: Extend the requested pinned order in the Python category:
...
--   5. TGS-2022014977 — WSQ AI Vibe Coding for Data Mining
--   6. TGS-2022014980 — WSQ Python Programming for Finance
--
...
SET cp.position = CASE p.sku
  WHEN 'TGS-2019503161' THEN -6
  WHEN 'TGS-2019504591' THEN -5
  WHEN 'TGS-2025052659' THEN -4
  WHEN 'TGS-2020503487' THEN -3
  WHEN 'TGS-2022014977' THEN -2
  WHEN 'TGS-2022014980' THEN -1
END
