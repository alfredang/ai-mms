-- 861: Pin TGS-2026062147 — "WSQ - No Code and Low Code Agentic AI
-- Applications" as the 3rd course in the Agentic AI Series category
-- (url_key 'agentic-ai-series'), restating the full pinned block:
...
--
-- Supersedes the pinned block from 858 (whose 4th slot was retired by 859 when
-- the Human-AI Workforce course moved to AI Agents Series). Claude Code shifts
-- from 3rd to 4th to make room.
--
...
-- normal positive positions (the 784/785/786 pattern). Category/products
-- resolved by business key. Idempotent.
...
SET cp.position = CASE p.sku
  WHEN 'TGS-2024045801' THEN -4
  WHEN 'TGS-2023035977' THEN -3
  WHEN 'TGS-2026062147' THEN -2
