-- 673: Re-apply curated non-WSQ category orders (third re-issue; copy of 656)
-- — REQUIRED in the same push as any global reorder (672), which flattens
-- Claude AI Series / Python / React back to alphabetical.
-- ---------------------------------------------------------------------------
