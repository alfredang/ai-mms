...
--   C330  - Tableau Desktop Basic Training
--   C1186 - Certified Information Systems Auditor (CISA) Training
--
-- Same pattern as migrations 833-841: default-scope (store_id 0) status set to
...
SET i.value = 2
WHERE i.attribute_id = @status_attr AND e.sku IN ('C330', 'C1186');
