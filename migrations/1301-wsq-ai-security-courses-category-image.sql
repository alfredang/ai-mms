-- 1301: Set the catalog banner image on the "WSQ AI Security Courses" category
-- (url_key wsq-ai-security-courses).
--
...
-- (catalog/category/wsq-ai-security-courses.jpg, uploaded + verified 200), and
...
SELECT 3, @cat_image, 0, @cat, 'wsq-ai-security-courses.jpg'
