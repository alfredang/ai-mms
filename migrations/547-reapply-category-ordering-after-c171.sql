-- Re-apply the canonical category ordering (verbatim copy of 545) after
-- repurposing C171 into the Git & Github category (546). WSQ first, then
-- non-WSQ C- alphabetical, then M/other — renumbering the index directly
-- (covers anchor-inherited rows). See skill category-ordering. Idempotent.
